...
Понимаю и принимаю, что настоящие условия могут быть изменены и (или) дополнены Оператором в одностороннем порядке без какого‑либо специального уведомления. Действующая редакция Согласия является открытым и общедоступным документом.`;
    ...
    function initMainApp(options = {}) {
        ...
        style.textContent = `
            ...
            #${CONTAINER_ID}.platform-max .lib-read-btn { min-height:30px; max-height:30px; padding:6px 18px; font-size:10px !important; line-height:1 !important; max-width:calc(100% - 4px); white-space:nowrap; -webkit-text-size-adjust:none !important; text-size-adjust:none !important; }
