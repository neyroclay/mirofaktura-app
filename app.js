  ...
  function renderContacts() {
    return screen(`
      <section class="contacts-hero">
        <p class="brand-label">Мирофактура</p>
        <h1>Маркетинг как единая система</h1>
        <p class="lead">Помогаем выстроить маркетинг целиком или берём в работу отдельную задачу: от позиционирования и фирменного стиля до привлечения клиентов, игровых воронок, автоматизации и ИИ-агентов.</p>
      </section>
