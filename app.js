(function () {
  ...
  if (IS_ROUTE_V2 && !document.querySelector('link[data-mirofactura-variant="route-v2"]')) {
    ...
    variantStyles.href = new URL('./route-v2.css?v=20260809-route-v2-transparent-stepan-07', document.baseURI).href;
  ...
  const assets = {
    ...
    stepanResources: IS_ROUTE_V2
      ? './assets/stepan-resources-question-v4.webp'
...
Не просто подписчиков и охваты, а деньги на счете.`
      ...
      return screen(`
        <div class="hero route-v2-home">
          ...
          <div class="home-copy route-v2-home-copy">
            ...
            <p class="lead">За несколько минут разберите текущую ситуацию: что вы продаёте, откуда приходят клиенты, чего хотите добиться и на какие ресурсы можете опереться. В конце вы получите краткий разбор своих ответов, практический совет и один из материалов Мирофактуры: атлас трафика, карту каналов продаж, конструктор продуктовой линейки или контент-навигатор.</p>
  ...
  function potapAdvice(key) {
    ...
    const scenarios = {
      traffic: {
        recommendation: IS_ROUTE_V2
          ? 'Подготовьте три версии одного поста или объявления. В каждой расскажите об одном продукте, но начните с разной ситуации клиента. Например, у человека выросла команда, перестал справляться старый способ или появилось новое направление. Запустите варианты в одинаковых условиях и сравните переходы, вопросы и заявки. Для дальнейшего продвижения выберите версию, которая привела больше целевых обращений.'
          : 'Сделайте три версии одного поста или объявления. В каждой рассказывайте об одном и том же продукте, но начинайте с разной ситуации клиента: выросла команда, перестал справляться старый способ, появилось новое направление. Проведите тесты в одинаковых условиях и сравните переходы, вопросы и заявки. Начните продвижение с версии, которая привлекла больше заинтересованных людей.',
  ...
  function routeV2AristarchCopy(key) {
    const copies = {
      ...
      'content-plan': 'Контент стоит строить вокруг задачи клиента и действия, к которому должна привести публикация, а не выпускать посты только ради регулярности.',
      products: 'Сначала сопоставьте продукты с ситуациями клиента. Посмотрите, какой продукт он покупает первым, какой результат получает и что ему можно предложить после этого.'
    };
  ...
  function renderResultV2() {
    ...
    return screen(`
      ...
      <article class="result-card route-v2-tool-card">
        <p class="brand-label">Материал для вашей задачи</p>
  ...
  function renderGate() {
    ...
    const copy = state.gateStatus === 'missing-id'
      ...
      : state.gateStatus === 'error'
        ...
        : isChecking
          ? IS_ROUTE_V2
            ? 'Проверяем подписку. Если подписка активна, материал откроется автоматически.'
    ...
    const panel = isLibraryGate
      ? `
        <div class="result-panel">
          ...
          <p>${IS_ROUTE_V2
            ? 'Полезные материалы Мирофактуры для поиска аудитории, выбора каналов продаж, работы с продуктовой линейкой и планирования контента.'
            : 'Полезные материалы Мирофактуры для практических задач бизнеса: разобраться в ситуации, сравнить варианты и выбрать подходящее решение.'}</p>
        </div>
      `
      : `
        <div class="result-panel">
  ...
  function renderLibrary() {
    return screen(`
      <div class="library-title">
        ...
        <h1>Кладовая</h1>
        <p class="lead">${IS_ROUTE_V2
          ? 'В Кладовой собраны четыре интерактивных материала: для поиска аудитории, выбора каналов продаж, работы с продуктовой линейкой и планирования контента. Каждый материал помогает разобрать конкретную задачу и сохранить результат.'
          : 'Здесь собраны четыре интерактивных материала: про привлечение аудитории, каналы продаж, линейку продуктов и контент. Они помогут разобрать задачу и сохранить первый рабочий план.'}</p>
    ...
    return screen(`
      ...
      <article class="lead-hero traffic-hero">
        <div>
          ...
          <p class="lead">Сузьте выбор источников трафика с учётом предложения, аудитории, географии, задачи и бюджета. После шести коротких вопросов вы получите список каналов, с которых можно начать. Наблюдения о площадках обновлены в июне 2026 года.</p>
        </div>
      </article>
