(function () {
  ...
  const marketingTasks = [
    {
      id: 'strategy',
      label: 'Найти, где теряются клиенты',
    ...
    {
      id: 'traffic',
      label: 'Превратить интерес в заявки и покупки',
      title: 'Продажи и интерактивные механики',
      text: 'Проверяем, что происходит после первого интереса: где человек узнаёт подробности, сравнивает варианты и оставляет заявку. На каждом этапе показываем, где посмотреть следующую информацию, выбрать подходящий вариант и оформить покупку. Если интерактив помогает принять решение, используем игру, бота или мини-приложение.',
      ...
      benefit: 'У бизнеса появляется понятная последовательность от первого интереса до заявки или покупки. По переходам видно, на каком этапе люди чаще останавливаются.'
    },
    {
      id: 'retention',
      label: 'Вернуть клиентов за следующей покупкой',
      title: 'Повторные обращения и продуктовая линейка',
    ...
    },
    {
      ...
      text: 'Превращаем идею в понятное предложение: определяем, для кого оно создано, какую задачу решает и что получит человек. Затем готовим подачу, материалы и сценарий запуска.',
      example: 'До большой разработки собираем первую версию продукта, показываем её будущим клиентам и проверяем, какие вопросы они задают и готовы ли оставить заявку.',
      benefit: 'Вы проверяете спрос до запуска полной версии и вкладываете время и деньги в продукт, к которому люди уже проявили интерес.'
    },
    {
      id: 'support',
      label: 'Вести маркетинг регулярно',
      title: 'Маркетинговое сопровождение',
      text: 'Планируем контент и запуски, готовим посты и рассылки, проводим игровые активности и смотрим, что приводит людей к заявке, покупке или повторному обращению.',
      ...
      benefit: 'Одна команда ведёт стратегию, контент, интерактивные продукты и аналитику. Вам не нужно координировать нескольких подрядчиков и каждый раз заново объяснять общую задачу.'
    },
    {
      id: 'automation',
      label: 'Сократить ручную работу',
      ...
      benefit: 'Команда тратит меньше времени на перенос данных и повторяющиеся операции. Заявки и важная информация не теряются между разными сервисами.'
    }
  ];
