    ...
    return screen(`
      ...
      <article class="lead-hero">
        <div>
          ...
          <p class="lead">Посмотрите, как сейчас связаны ваши продукты и где клиенту не хватает понятного следующего шага. В конце вы выберете подходящую модель и соберёте черновик продуктовой линейки.</p>
        </div>
      </article>
  ...
  function renderContacts() {
    return screen(`
      <section class="contacts-hero">
        ...
        <p class="lead">Мы называем такие системы фактурными мирами: в них есть характер бренда, продуманные сценарии вовлечения и современные технологии — от сайтов и мини-приложений до автоматизации и ИИ-агентов.</p>
      </section>
