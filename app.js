(function () {
  ...
  const NATIVE_TRENDS_ASSET_VERSION = '20260717-scroll-gesture-33';
  ...
  app.addEventListener('click', async (event) => {
    ...
    if (action === 'share') {
      ...
      const text = 'Мирофактура создаёт интерактивные продукты и ведёт маркетинг вокруг них: от стратегии, контента и маскотов до игр, квизов, мини-приложений и связанных экосистем.';
