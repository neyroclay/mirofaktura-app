  ...
  const marketingTasks = [
    {
      ...
      example: 'У онлайн-школы несколько программ, но новым ученикам сложно выбрать подходящий уровень. Мы упрощаем линейку, проектируем маршрут до заявки и определяем, где нужен текст, а где лучше сработает квиз или другой интерактивный формат.',
  ...
  function renderContacts() {
    ...
    return screen(`
      <section class="contacts-hero">
        ...
        <p class="lead">Помогаем бизнесу объяснить ценность продукта, удержать внимание аудитории и превратить интерес в заявки и покупки. Сначала определяем стратегию, затем создаём нужное решение: упаковку и контент, игру, квиз, мини-приложение или связанную цифровую систему.</p>
