(function () {
  ...
  function potapAdvice(key) {
    ...
    const scenarios = {
      traffic: {
        recommendation: 'Найдите 3–5 человек, которые уже решают эту задачу без вашего продукта: вручную, с подрядчиком или с помощью похожего сервиса. Спросите, что в нынешнем решении отнимает слишком много времени, обходится дорого или не даёт нужного результата. Их ответы помогут точнее сформулировать предложение и понять, где искать первых клиентов.',
        map: 'Выпишите три ситуации, в которых человеку может понадобиться ваш продукт. Для каждой отметьте: что произошло, как человек решает проблему сейчас и сколько времени или денег на это уходит. Сначала проверьте ситуацию, где проблема возникает часто и уже обходится человеку дорого.',
        draft: 'Опишите будущих клиентов не только по возрасту, профессии или размеру бизнеса. Добавьте ситуацию, которая приводит их к поиску решения: выросла команда, перестал справляться старый инструмент или появилось новое направление. Для каждой ситуации запишите задачу человека и результат, который может дать ваш продукт.'
      },
      sales: {
        recommendation: 'Проведите несколько прямых разговоров с нынешними или потенциальными клиентами — в переписке, на созвоне или при встрече. Запишите вопросы, которые они задают перед покупкой, и причины, по которым откладывают покупку. Повторяющиеся вопросы и причины покажут, что нужно добавить в описание продукта, а что лучше объяснять лично.',
        map: 'Сначала определите, что клиент должен увидеть или узнать до покупки. Если продукт трудно оценить по описанию, покажите его в работе или предложите пробную версию. Если предложение зависит от ситуации клиента, обсудите её в переписке или на созвоне. После этого станет понятно, что вам нужнее: сайт с подробным описанием, демонстрация, переписка или личная встреча.',
        draft: 'Разложите продажу по шагам: где человек впервые видит предложение, где узнаёт условия, где задаёт вопросы и где оплачивает покупку. Для каждого шага укажите, где он происходит: на сайте, в соцсети, в переписке или на встрече. Так вы заметите лишние повторы и этапы, после которых клиенту не предлагают следующего действия: написать, записаться или оплатить.',
      },
      products: {
        recommendation: 'Возьмите главный продукт — тот, который уже приносит основную выручку или который вы планируете запустить первым. Запишите, какую задачу клиента решает этот продукт, какой результат получает человек и какая новая задача возникает после этого. Последний ответ подскажет, что можно предложить клиенту после основного продукта.',
        map: 'Распределите идеи по трём группам: что готовит клиента к основному продукту, что дополняет полученный результат, а что решает отдельную задачу. Из первых двух групп можно собрать последовательную линейку. Идеи из третьей лучше оставить самостоятельными предложениями.',
        draft: 'Для каждого продукта запишите три вещи: кому он подходит, какую задачу решает и какой результат получает клиент. Затем расположите продукты в том порядке, в котором они могут понадобиться одному и тому же клиенту. Если один и тот же клиент вряд ли купит эти продукты по очереди, возможно, часть продуктов рассчитана на другую аудиторию или решает отдельную задачу.'
      }
    };
