  ...
  function renderContacts() {
    return screen(`
      <section class="contacts-hero">
        ...
        <p class="lead">Проектируем сайты, боты и мини-приложения, которые помогают показать продукт, вовлечь аудиторию и привести человека к нужному действию.</p>
      </section>
      ...
      <section class="services-panel" aria-label="Услуги Мирофактуры">
        ...
        <div class="service-list">
          ...
          <article class="service-card">
            ...
            <div>
              <h2>Интерактивные продукты</h2>
              <p>Создаём квизы, диагностики, игры и полезные инструменты для маркетинга. Они знакомят аудиторию с продуктом, помогают собрать запросы и подводят к следующему шагу.</p>
            </div>
          </article>
          <article class="service-card">
            <span class="service-number">04</span>
            <div>
              <h2>Клубы и программы лояльности</h2>
              <p>Объединяем материалы, события, бонусы и подписку в одном приложении. Клиент видит свои возможности и может вернуться к тому, что ему уже доступно.</p>
            </div>
          </article>
        </div>
      </section>
